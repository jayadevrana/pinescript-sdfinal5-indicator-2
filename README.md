...
This repository contains a Pine Script source file saved as `pinescript_sdfinal5_indicator_2.txt` so it opens easily on GitHub and can be copied into TradingView.
...
3. Copy the code from `pinescript_sdfinal5_indicator_2.txt`.
